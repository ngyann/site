      ...
      <section className="bg-[#f5f5f5] py-10" id="alignogram-section">
        ...
        <div className="container mx-auto px-5 md:px-10 flex flex-col-reverse md:flex-row items-center justify-between font-['Sora'] text-[18px] font-[400]">
          <div className="md:mr-10">
            <p>
              The Disorganization (Misalignment) detector<br></br>
          ...
          <img className="w-full md:w-[500px] h-[250px] rounded-lg mb-5 md:mb-0" src={images.alignogram} />
        </div>
        ...
        <div className="container mx-auto px-5 md:px-10 flex flex-col md:flex-row items-center justify-between font-['Sora'] text-[18px] font-[400] mt-10">
          <div className="flex flex-col md:flex-row items-start">
            <div className="md:mr-5 mb-5 md:mb-0">
              <img src={images.pop} className="w-full md:w-[450px] h-[250px] rounded-lg" />
              <p>X-ray of the femur of a patient on long-time antiresorptive therapies. Showing cortical thickening and endosteal protrusion of the cortex (yellow dotted square)</p>
            </div>
            <div className="md:mx-5 mb-5 md:mb-0">
              <img src={images.fermure} className="w-full md:w-[450px] h-[250px] rounded-lg" />
              <p>The Alignogram indicating the level of disorganization (Critical Disorganization value, Expected Disorganization), and the Disorganization value.</p>
            </div>
            <div className="md:ml-5">
              <img src={images.leg} className="w-full md:w-[450px] h-[250px] rounded-lg" />
              <p>An X-ray image sample of the leg showing the femur bone.</p>
            </div>
          </div>
        </div>
      </section>
